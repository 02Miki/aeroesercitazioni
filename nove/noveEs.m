...
maxEta = 6;
etaSpan = [0, maxEta]; % max valore 11 (se uso [0 1 0] come f0, altrimenti max 7), dopo il solver ha problemi, il warning è utile per capire se soluzione è accettabile o no
